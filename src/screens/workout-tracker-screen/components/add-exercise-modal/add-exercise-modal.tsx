...
import type { ExerciseForWorkout, ICreateWorkoutTemplateExercise } from 'src/interfaces';
...
interface Props {
    ...
    exercisesInWorkout: WorkoutFormExercise[] | ICreateWorkoutTemplateExercise[];
